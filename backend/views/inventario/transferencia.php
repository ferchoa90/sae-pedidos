...
$this->title = "Transferencia de inventario";
...
?>
    ...
    <?= Html::a(Html::tag('i', '', ['class' => 'fa fa-plus']) . '&nbsp; Nueva Transferencia', ['nuevatransferencia'], ['class' => 'btn btn-primary']) ?>
<br>
<br>
    <div class="box">
        <div class="box-body">
...
<?php
$this->registerJsFile(URL::base() . "/js/class/inventariotransAdmin.js", ['depends' => [ \yii\bootstrap\BootstrapPluginAsset::className()]
]);