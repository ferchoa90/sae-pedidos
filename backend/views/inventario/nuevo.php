  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-3-typeahead/4.0.2/bootstrap3-typeahead.min.js"></script>  
    ...
    <div class="trivia-head-create">
        <div class="box-body">
            ...
            <?= Html::a(Html::tag('i', '', ['class' => 'fa fa-plus']) . '&nbsp; Agregar Unidad', ['nuevounidad'], ['class' => 'btn btn-primary']) ?>
        </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-4 col-xs-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" id="presentacion">
                                        <option >seleccione...</option>
                                        <?php $cont=0; foreach ($presentaciones as $key => $value) { ?>
                                            <option value="<?=$value->id ?>" <?php if($cont==0){ echo 'selected="selected" ';  } ?>  ><?=$value->nombre ?></option>
                                        <?php $cont++; } ?>
                                    </select>
                                </div><!-- /.input group -->
                            ...
                            <div class="form-group col-md-4 col-xs-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" id="calidad">
                                        <option >seleccione...</option>
                            ...
                            <div class="form-group col-md-4 col-xs-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" id="clasificacion">
                                        <option >seleccione...</option>
                            ...
                            <div class="form-group col-md-4 col-xs-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control pull-right" id="stocki" name="stocki" min=1 value="1"  step=".01">
                                </div><!-- /.input group -->
                            </div><!-- /.form group -->
                            <div class="form-group col-md-4 col-xs-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control pull-right" id="stockf" name="stockf" min=1 value="1" step=".01">
                                </div><!-- /.input group -->
                            </div><!-- /.form group -->
                            <div class="form-group col-md-4 col-xs-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control pull-right" id="stock" name="stock" min=1 value="1" step=".01">
                                </div><!-- /.input group -->
                            </div><!-- /.form group -->
                            <div class="form-group col-md-4 col-xs-4">
                                <label>Costo:</label>
