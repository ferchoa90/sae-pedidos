...
$this->params['breadcrumbs'][] = ['label' => 'Administración de Servicios', 'url' => ['index']];
                ...
                <div class="col-md-12 col-xs-12">
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title">Configuración de Servicio</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-3">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-4 col-xs-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="currency" class="form-control pull-right" id="valor" name="valor" value="0,00">
...
$this->registerJsFile(URL::base() . "/js/class/serviciosNew.js", [
    'depends' => [\yii\bootstrap\BootstrapPluginAsset::className()]
]);
