                ...
                <div class="col-md-6 col-xs-6">
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title">Configuración de Banner</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-4">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control pull-right" id="nombre" name="nombre" value="<?=$model->titulo?>">
                                </div><!-- /.input group -->
                            </div><!-- /.form group -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="file" class="form-control pull-right" id="image" name="image"  value="<?=$model->image?>"  accept="image/png, image/jpeg">
                                </div><!-- /.input group -->
                            </div><!-- /.form group -->
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="file" class="form-control pull-right" id="imageresponsive" name="imageresponsive"  value="<?=$model->imageresponsive?>"  accept="image/png, image/jpeg">
                                </div><!-- /.input group -->
                            </div><!-- /.form group -->
...
$this->registerJsFile(URL::base() . "/js/class/sliderNew.js", [
    'depends' => [\yii\bootstrap\BootstrapPluginAsset::className()]
]);
