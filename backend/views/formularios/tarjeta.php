...
?>
    ...
    <?= Html::a(Html::tag('i', '', ['class' => 'fa fa-file-excel-o']) . '&nbsp; Exportar a CSV', ['export?encuesta=tarjeta'], ['class' => 'btn btn-success']) ?>
...
<?php
$this->registerJsFile(URL::base() . "/js/class/tarjetasAdmin.js", ['depends' => [ \yii\bootstrap\BootstrapPluginAsset::className()]
]);
