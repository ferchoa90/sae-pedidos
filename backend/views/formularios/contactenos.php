...
?>
    ...
    <?= Html::a(Html::tag('i', '', ['class' => 'fa fa-file-excel-o']) . '&nbsp; Exportar a CSV', ['export?encuesta=contactenos'], ['class' => 'btn btn-success']) ?>
   <br>
<br>
    <div class="box">
        <div class="box-body">
...
<?php
$this->registerJsFile(URL::base() . "/js/class/contactenosAdmin.js", ['depends' => [ \yii\bootstrap\BootstrapPluginAsset::className()]
]);
