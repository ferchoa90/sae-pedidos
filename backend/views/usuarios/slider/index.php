...
$this->title = "Administración de Slider";
...
?>
    ...
    <?= Html::a(Html::tag('i', '', ['class' => 'fa fa-plus']) . '&nbsp; Agregar Banner', ['nuevo'], ['class' => 'btn btn-primary']) ?>
<br>
<br>
    <div class="box">
        <div class="box-body">
...
<?php
$this->registerJsFile(URL::base() . "/js/class/sliderAdmin.js", ['depends' => [ \yii\bootstrap\BootstrapPluginAsset::className()]
]);
