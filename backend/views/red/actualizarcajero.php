...
?>
    <input type="hidden" id="action" value="actualizarcajero?id=<?= $model->id ?>">
                ...
                <div class="col-md-6 col-xs-6">
                    <div class="box box-solid">
                        <div class="box-header with-border">
                            ...
                            <h3 class="box-title">Información de Cajero</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
...
$this->registerJsFile(URL::base() . "/js/class/cajerosNew.js", [
    'depends' => [\yii\bootstrap\BootstrapPluginAsset::className()]
]);
