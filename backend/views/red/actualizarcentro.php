...
$this->title = 'Actualizar Centro Médico';
...
?>
    <input type="hidden" id="action" value="actualizarcentro?id=<?= $model->id ?>">
                ...
                <div class="col-md-6 col-xs-6">
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title">Configuración de Centro Médico</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-4">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="tipocentro" name="tipocentro"  class="form-control pull-right">
                                        <?php foreach ($tipocentro as $key => $value) { ?>
                                            <option  <?php if ($value->id == $model->idtipo) { echo 'selected="selected"';  } ?> value="<?=$value->id ?>"><?=$value->nombre ?></option>
                                        <?php } ?>
                                    </select>
                ...
                <div class="col-md-6 col-xs-6">
                    <div class="box box-solid">
                        <div class="box-header with-border">
                            ...
                            <h3 class="box-title">Información de Centro Médico</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
...
$this->registerJsFile(URL::base() . "/js/class/centromedicoNew.js", [
    'depends' => [\yii\bootstrap\BootstrapPluginAsset::className()]
]);
