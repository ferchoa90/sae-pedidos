...
$this->title = "Administración de Centros Médicos";
...
?>
    ...
    <?= Html::a(Html::tag('i', '', ['class' => 'fa fa-plus']) . '&nbsp; Agregar Centro Médico', ['nuevocentro'], ['class' => 'btn btn-primary']) ?>
    <br>
<br>
    <div class="box">
        <div class="box-body">
...
<?php
$this->registerJsFile(URL::base() . "/js/class/centrosmedicosAdmin.js", [
    'depends' => [
