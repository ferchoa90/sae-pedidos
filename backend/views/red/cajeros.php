...
$this->title = "Administración de Oficinas";
...
?>
    ...
    <?= Html::a(Html::tag('i', '', ['class' => 'fa fa-plus']) . '&nbsp; Agregar Oficina', ['nuevocajero'], ['class' => 'btn btn-primary']) ?>
    <br>
<br>
    <div class="box">
        <div class="box-body">
...
<?php
$this->registerJsFile(URL::base() . "/js/class/oficinasAdmin.js", [
    'depends' => [
