...
$this->title = "Ver Acceso Directo";
$this->params['breadcrumbs'][] = ['label' => 'Administración de Accesos Directos', 'url' => ['index']];
        ...
        <div class="col-md-6">
            <div class="box box-solid">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title">Información de Acceso Directo</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
        ...
        <div class="col-md-6">
            <div class="box box-solid">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title">Configuración del Acceso Directo</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <dl class="dl-horizontal">
                        <dt>Orden:</dt>
