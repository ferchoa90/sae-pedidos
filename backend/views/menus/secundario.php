...
$this->title = "Administración de Menus";
...
?>
    ...
    <?= Html::a(Html::tag('i', '', ['class' => 'fa fa-plus']) . '&nbsp; Agregar Submenu', ['nuevosubmenu'], ['class' => 'btn btn-primary']) ?>
    <br>
<br>
    <div class="box">
        <div class="box-body">
...
<?php
$this->registerJsFile(URL::base() . "/js/class/menusecundarioAdmin.js", [
    'depends' => [
