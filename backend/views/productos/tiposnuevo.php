...
$this->params['breadcrumbs'][] = ['label' => 'Administración de Tipos', 'url' => ['index']];
                ...
                <div class="col-md-7 col-xs-7">
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title">Configuración de Tipo</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-3">
...
$this->registerJsFile(URL::base() . "/js/class/productostipoNew.js", [
    'depends' => [\yii\bootstrap\BootstrapPluginAsset::className()]
]);
