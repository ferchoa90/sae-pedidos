...
$this->title = "Administración de Presentaciones";
...
?>
    ...
    <?= Html::a(Html::tag('i', '', ['class' => 'fa fa-plus']) . '&nbsp; Agregar Presentaciones', ['presentacionnueva'], ['class' => 'btn btn-primary']) ?>
...
$this->registerJsFile(URL::base() . "/js/class/productopresAdmin.js", ['depends' => [ \yii\bootstrap\BootstrapPluginAsset::className()]
