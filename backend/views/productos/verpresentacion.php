...
$this->title = "Ver Presentación";
$this->params['breadcrumbs'][] = ['label' => 'Administración de Presentación', 'url' => ['index']];
        ...
        <div class="col-md-6">
            <div class="box box-solid">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title">Información de Presentación</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
        ...
        <div class="col-md-6">
            <div class="box box-solid">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title">Configuración de la Presentación</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
