        ...
        function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.success) {
                        loading(1);
                        $.notify('Se ha generado un nuevo producto');
                        if (data.id) {
                            window.location.href = "verproducto?id=" + data.id;
                        }
                    } else {
                        loading(0);
                        $.notify(data.Mensaje);
    ...
    swal({
        ...
        function() {
            ...
            if (document.getElementById('imagen')) {
                archivo = document.getElementById('imagen').files;
            } else {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.success) {
                        loading(1);
                        $.notify('Se ha actualizado el producto');
                        if (data.id) {
                            window.location.href = "verproducto?id=" + data.id;
                        }
                    } else {
