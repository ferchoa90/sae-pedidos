        ...
        <div class="col-md-4 col-sm-6">
            <div class="product-grid6">
                ...
                <div class="product-content">
                    <h3 class="title"><a href="#"><?= $value->nombre ?></a></h3>
                    <div class="price"><?= $value->valor ?>
                        <span>$<?= $value->valor+10 ?></span>
                    </div>
                </div>
                <ul class="social">
                    <li><a href="<?= URL::base() ?>/site/clase?id=<?= $value->id ?>" data-tip="Ver más"><i class="fa fa-search"></i></a></li>
                    <!-- <li><a href="" data-tip="Add to Wishlist"><i class="fa fa-shopping-bag"></i></a></li> -->
                    <li><a href="<?= URL::base() ?>/site/clase?id=<?= $value->id ?>" data-tip="Comprar"><i class="fa fa-shopping-cart"></i></a></li>
                </ul>
            </div>
        </div>
        <?php } ?>
