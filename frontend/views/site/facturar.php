            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between align-middle">
                  ...
                  <h6 class="m-0 font-weight-bold text-primary col-4 col-xs-4 d-table-cell vertical-center  align-middle">
...
&nbsp;&nbsp;
                  ...
                  <h6 class="m-0 font-weight-bold text-primary col-7 col-xs-7">
                        <div class="input-group">
                            ...
                            -->
                            <div class=" p-2 ">
                              <a href="javascript:obtenerProducto('2 - ALMUERZO');" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm"><i class="fas fa-coffee fa-sm text-white-50"></i> ALM</a>
                            </div>

                            <div class=" p-2 ">
                              <a href="javascript:obtenerProducto('3 - SEGUNDO');" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm"><i class="fas fa-coffee fa-sm text-white-50"></i> SEG</a>
                            </div>

                            <div class=" p-2 ">
                              <a href="javascript:obtenerProducto('4 - VIANDA');" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm"><i class="fas fa-coffee fa-sm text-white-50"></i> VIA</a>
                            </div>

                            <div class=" p-2 ">
                              <a href="javascript:obtenerProducto('6 - JUGO');" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm"><i class="fas fa-coffee fa-sm text-white-50"></i> JUG</a>
                            </div>
  ...
  inicializarFactura();
    ...
    function generarFactura()
    {
      ...
      $.ajax({
          url:\"ingresarfactura\",
          method:\"POST\",
          data: { data: dataFactura, cliente:cliente,'_csrf-frontend':'".Yii::$app->request->getCsrfToken()."', formapago:formapago },
          //dataType:\"json\",
          success:function(data)
          {
